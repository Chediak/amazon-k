<template>
    <div>
        <header class="nav-opt-sprite nav-locate-us nac-lang-en nav-ssl nav-unrec">
                        ...
                        <div class="nav-tools">
                            <a href="#" id="icp-nav-flyout" class="nav-a nav-a-2 icp-link-style-2">
                                <span class="icp-nav-link-inner">
                                    ...
                                    <span class="nav-line-2">
                                        &nbsp;
                                        <span class="nav-icon nav-arrow" style="visibility"></span>
                                    </span>
                                </span>
                            </a>
                            <span class="icp-nav-line-border"></span>
                            ...
                            >
                                    ...
                                    <span class="nav-line-2"> {{ $auth.$state.user.name }}
                                <span 
                                class="nac-icon nav-arrow" 
                            ...
                            <span class="nav-line-2">
                                Account &amp; Lists
                                <span class="nac-icon nav-arrow" style="visibility: visible"></span>
                            </span>
                            </nuxt-link>
                            </template>
